        ...
        <div>
            <script type="text/html" id="toolbar">
                <div class="layui-btn-container">
                    <button id="btn_user_add" class="layui-btn layui-btn-sm"><i
                            class="layui-icon layui-icon-add-1"></i>导入</button>
    ...
    <form style="width:300px;margin-top:20px;" class="layui-form" lay-filter="user_add_form">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="tel" lay-reqText="请输入账号" lay-verify="required|tel" placeholder="请输入账号"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="name" lay-verify="required" placeholder="请输入姓名" lay-reqText="请输入昵称"
                       autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
    ...
    layui.use(['form','upload','table','element'], function(){
        ...
        var tableIns=table.render({
            ...
            ,cols: [[ //表头
                ...
                ,{field: 'tel', title: '账号',align:'center'}
